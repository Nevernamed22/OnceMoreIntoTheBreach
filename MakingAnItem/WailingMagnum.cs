...
namespace NevernamedsItems
{
    ...
    public class WailingMagnum : GunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            Gun gun = ETGMod.Databases.Items.NewGun("Wailing Magnum", "wailingmagnum");
            ...
            gun.SetBaseMaxAmmo(166);
            // Here we just set the quality of the gun and the "EncounterGuid", which is used by Gungeon to identify the gun.
            gun.quality = PickupObject.ItemQuality.EXCLUDED;
            gun.encounterTrackable.EncounterGuid = "this is the Wailing Magnum";
        ...
        {
            ETGModConsole.Log("You reloaded the Wailing Magnum");
