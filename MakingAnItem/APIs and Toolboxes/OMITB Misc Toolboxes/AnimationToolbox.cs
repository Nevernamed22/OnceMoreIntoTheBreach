...
namespace NevernamedsItems
{
    ...
    public static class AnimationUtilityExtensions
    {
        ...
        public static void AddAnimationToObjectAssetBundle(this GameObject target, tk2dSpriteCollectionData spriteCollection, string animationName, List<string> sprites, int fps, Vector2 colliderDimensions, Vector2 colliderOffsets, tk2dBaseSprite.Anchor anchor, tk2dSpriteAnimationClip.WrapMode wrapMode, bool isDefaultAnimation = false)

        {
            ...
            {
                int frameSpriteId = spriteCollection.GetSpriteIdByName(path);
                ...
                frameDef.ConstructOffsetsFromAnchor(anchor);
                frames.Add(new tk2dSpriteAnimationFrame { spriteId = frameSpriteId, spriteCollection = spriteCollection });
            }
            clip.frames = frames.ToArray();
            clip.wrapMode = wrapMode;
            animation.clips = animation.clips.Concat(new tk2dSpriteAnimationClip[] { clip }).ToArray();
