...
namespace NevernamedsItems
{
    ...
    public class FlayedRevolver : GunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            gun.encounterTrackable.EncounterGuid = "this is the Flayed Revolver";
