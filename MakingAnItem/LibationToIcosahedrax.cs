...
namespace NevernamedsItems
{
    class LibationtoIcosahedrax : PlayerItem
    {
        ...
        {
            PlayerItem item = ItemSetup.NewItem<LibationtoIcosahedrax>(
               "<WIP> Libation to Icosahedrax <WIP>",
               "Standing Oblation",
               "This ancient chalice is inscribed with 1, 100, and all the numbers in between. The runes inside the cup constantly ooze 'challenge juice', keeping this offering forever-full.",
               "libation_icon") as PlayerItem;
