...
namespace NevernamedsItems
{
    class InitialiseSynergies
    {
        public static void DoInitialisation()
        {
            ...
            //TABLE TECH AMMO / AMMO BELT
            CustomSynergies.Add("Tabletop",
                new List<string>() { "nn:table_tech_ammo", "ammo_belt" });
            #endregion
           ...
           AdvancedSynergyEntry RedBirds = CustomSynergies.Add("Redbirds", mandatorySynergyItemsRedbirds);
            ...
            //DARC RIFLE
            List<string> mandatorySynergyItemsDARCRifle = new List<string>() { "nn:arc_rifle" };
            ...
            CustomSynergies.Add("DARC Tactical",
                new List<string>() { "nn:arc_tactical" },
                new List<string>() { "riddle_of_lead", "nn:cloak_of_darkness", "dark_marker" });

            CustomSynergies.Add("DARC Cannon",
                new List<string>() { "nn:arc_cannon" },
                new List<string>() { "riddle_of_lead", "nn:cloak_of_darkness", "dark_marker" });

            CustomSynergies.Add("Bloodwash",
                new List<string>() { "nn:laundromateriel_rifle" },
                new List<string>() { "bloody_9mm", "blood_brooch", "nn:bloodthirsty_bullets", "nn:hematic_rounds", "nn:bloody_box" });
