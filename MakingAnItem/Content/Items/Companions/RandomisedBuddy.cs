...
namespace NevernamedsItems
{
    public class RandomisedBuddyController : CompanionController
    {
        ...
        /*B*/    "baba", "blinky", "boo", "bunnybullet", "birdblue", "birdgreen", "birdpurple", "birdyellow", "blackstache", "blasthelmet", "blocknerghost", "brotheralbern", "bubbleblack", "bulletfrost", "bulletshadow", "bulletshockrounds", "beigeball", "blazeykat",
        ...
        /*D*/   "defaultman", "darumablue", "darumabrown", "darumared", "decoy", "decoyice", "decoypoison", "demonhead", "detex", "detplus", "ddebot1", "ddebot2", "drifloon", "disambig",
        ...
        /*F*/   "fygar", "froggy", "fuselier", "flemoid", "fredchexter", "freetvs", "freakout1", "freakout2",
        ...
        /*J*/   "jellyblorb", "jetpackcat", "jon",
        /*K*/   "kingslime", "kernal", "kylethescientist",
        /*L*/   "leshy", "labtech", "lala", "lamey", "lameyalt", "lasthuman", "lichbullets", "lolo", "looplich", "lowpriest", "lonelywizard",
        /*M*/   "magnificus", "mainframe", "minesweepersmiley", "miru", "mrdonut", "mrmatt", "mrspacman", "magnet", "manny", "marinegray", "marinegreen", "marinered", "marineyellow", "marketdoor", "maskred", "mauser", "metroidbaby", "monk", "moogleff4", "mooglemodern", "moon", "mushroom1up", "mushroomlife", "mushroomred", "mushroomstar", "mushroomvarg", "meowitzerchievo", "mrmagnum", "mern", "mushroomvine",
        /*N*/   "nanomachine", "ninja", "notabotclassic", "notabot2000",
        /*O*/   "oldnevernamed","octorok", "oldblood", "oldknight", "owlskeleton",
        /*P*/   "p03", "pacman", "perfection", "pinky", "poglizard", "personalityfear", "personalityrage", "phanto", "phantogold", "piku", "plasmacube", "peglin", "purplefairy",
        /*R*/   "randal", "revolvenant", "rippy", "rubberjester",
        /*S*/   "sansyskeleton", "scaredghost", "scrappeddebugenemy", "semibot", "settingsbutton", "slenderman", "stickman", "sue", "scientistchilds","scientistdukes", "sepulchergeist", "serenade", "skullred", "snitchbrick", "spaceboy", "spacehole", "spiketrap", "spindrone", "steambot", "stonehead", "sun", "skifreeyeti", "spoilsportrobot", "stockguy", "spanospy", "solaroracle", "somebunny",
        /*T*/   "tcboutblue", "tcboutred", "technoblade", "textfilebuddy", "thedreamer", "thepointyone", "thomasthebullet", "turtlemelon", "terminator", "tootscraze", "toughguy", "theguyfromelevatoraction", "theblind",
        /*U*/   "ufo",
        /*V*/   "voidcore", "vvvvvv",
