...
namespace NevernamedsItems
{
    public class EnemyApproachingHopper : MovementBehaviorBase
    {
        ...
        private void Land()
        {
            ...
            if (this.m_aiActor.specRigidbody.UnitCenter.GetAbsoluteRoom() == null || (Owner.IsInCombat && this.m_aiActor.specRigidbody.UnitCenter.GetAbsoluteRoom() != Owner.CurrentRoom) || (!Owner.IsInCombat && Vector2.Distance(this.m_aiActor.CenterPosition, Owner.CenterPosition) > teleportCatchUpDistance))
            {
                base.m_aiActor.CompanionWarp(Owner.CenterPosition);
            }
        }
