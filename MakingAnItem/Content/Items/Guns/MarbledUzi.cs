...
namespace NevernamedsItems
{
    public class MarbledUzi : AdvancedGunBehavior
    {
        ...
        {
            GUIDs.Bullet_Kin,
            GUIDs.Bullet_Kin_AK47,
            GUIDs.Bandana_Bullet_Kin,
            GUIDs.Veteran_Bullet_Kin,
            GUIDs.Tanker,
            GUIDs.Minelet,
            GUIDs.Cardinal,
            GUIDs.Ashen_Bullet_Kin,
            GUIDs.Mutant_Bullet_Kin,
            GUIDs.Fallen_Bullet_Kin,
            GUIDs.Office_Bullet_Kin,
            GUIDs.Office_Bullette_Kin,
            GUIDs.Brollet,
            GUIDs.Western_Bullet_Kin,
            GUIDs.Pirate_Bullet_Kin,
            GUIDs.Tanker_Summoned,
            GUIDs.Gummy,
            GUIDs.Tutorial_Bullet_Kin,
            GUIDs.Expand.Hotshot_Bullet_Kin,
            GUIDs.Expand.Bootleg_Bullet_Kin,
            GUIDs.Expand.Bootleg_Bandana_Bullet_Kin,
            GUIDs.Planetside.Wailer,
            GUIDs.OMITB.Bouncer_Bullet_Kin,
        };
    }
}