...
{
    class HelixProjectileButLessShit : Projectile
    {
        public HelixProjectileButLessShit()
        {
        ...
        public override void Start()
        {
            ...
            if (SpawnShadowBulletsOnSpawn)
            {
                if (randomiseChainNum)
                {
                    ...
                    if (selectednum > 0)
                    {
                        this.SpawnChainedShadowBullets(selectednum, pauseLength, chainScaleMult, overrideProjectile);
                    }
                }
                else
                {
                    this.SpawnChainedShadowBullets(NumberInChain, pauseLength, chainScaleMult, overrideProjectile);
                }
            }
